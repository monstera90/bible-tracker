...
(function(){
  ...
  // — ниже, через bottom:-39px, см. modals.css). Проценты 0..100 этот
  ...
  function layoutSettingsModal(){
    ...
    // а высота отсчитывается от НЕЁ вверх — фиксированные 673px (WINDOW_H
    ...
    // оверлея, см. padding-top). Если 673px не помещается (см. minTop —
